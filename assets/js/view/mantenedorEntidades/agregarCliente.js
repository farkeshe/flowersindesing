(function() {
  ...
  define(['backbone', 'text!tpl/mantenedorEntidades/nueva.html', 'assets/js/model/entidad'], function(Backbone, TplViewAddCliente, EntidadesModel) {
    var agregarCliente;
    return agregarCliente = (function(superClass) {
      extend(agregarCliente, superClass);
      ...
      function agregarCliente() {
        ...
        return agregarCliente.__super__.constructor.apply(this, arguments);
      }

      agregarCliente.prototype.initialize = function() {
        this.entidadModel = new EntidadesModel();
        this.entidadModel.buscarCategorias(this.cargarClasificacionEnMemoria);
        return this.init();
      };

      agregarCliente.prototype.init = function() {
      ...
      agregarCliente.prototype.cargarClasificacionEnMemoria = function(clasificacion) {
        return this.clasificacion = clasificacion;
      };

      agregarCliente.prototype.verificarexistencia = function(data) {
